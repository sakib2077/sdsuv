...
const AboutUs: React.FC<AboutUsProps> = ({ language, setCurrentPage, onBack }) => {
  const content = {
    en: {
    ...
    <div className="about-us-page">
      ...
      <section className="intro-section">
        <div className="intro-content">
          ...
          <p className="intro-tagline">{data.tagline}</p>
          <p className="intro-description">{data.description}</p>
      ...
      <section className="introduction-section">
        <h2 className="section-title">{data.introductionTitle}</h2>

        {/* 4 Cards Grid */}
        <div className="intro-cards-grid">
          <div className="intro-card">
            <h3 className="card-title">{data.establishment}</h3>
            <div className="card-divider"></div>
            <p className="card-content">{data.establishmentContent}</p>
          </div>

          <div className="intro-card">
            <h3 className="card-title">{data.geographic}</h3>
            <div className="card-divider"></div>
            <p className="card-content">{data.geographicContent}</p>
          </div>

          <div className="intro-card">
            <h3 className="card-title">{data.campus}</h3>
            <div className="card-divider"></div>
            <p className="card-content">{data.campusContent}</p>
          </div>

          <div className="intro-card">
            <h3 className="card-title">{data.connectivity}</h3>
            <div className="card-divider"></div>
            <ul className="connectivity-list">
              <li><strong>✈ {data.nearestAirport}</strong></li>
              <li><strong>🚂 {data.nearestRailway}</strong></li>
              <li><strong>🛣️ {data.roadConnectivity}</strong></li>
              <li><strong>🕐 {data.travelTime}</strong></li>
              <li><strong>🚌 {data.transport}</strong></li>
            </ul>
          </div>
        </div>
        ...
        <div className="objects-section">
          <h2 className="objects-title">{data.objects}</h2>
          <p className="objects-description">{data.objectsDescription}</p>

          <div className="objectives-grid">
            <div className="objective-card">
              <div className="objective-icon">{data.objective1Icon}</div>
              <h4 className="objective-title">{data.objective1Title}</h4>
              <p className="objective-desc">{data.objective1Desc}</p>
            </div>

            <div className="objective-card">
              <div className="objective-icon">{data.objective2Icon}</div>
              <h4 className="objective-title">{data.objective2Title}</h4>
              <p className="objective-desc">{data.objective2Desc}</p>
            </div>

            <div className="objective-card">
              <div className="objective-icon">{data.objective3Icon}</div>
              <h4 className="objective-title">{data.objective3Title}</h4>
              <p className="objective-desc">{data.objective3Desc}</p>
            </div>

            <div className="objective-card">
              <div className="objective-icon">{data.objective4Icon}</div>
              <h4 className="objective-title">{data.objective4Title}</h4>
              <p className="objective-desc">{data.objective4Desc}</p>
            </div>
          </div>
        </div>
      </section>
